...
function Pronunciation({ difficulty, onNextDifficulty }) {
  ...
  useEffect(() => {
    if (roundComplete || questionTimeLeft > 0 || isProcessing) return;
  ...
  }, [questionTimeLeft, roundComplete, isProcessing, index, roundLength, points]);
